  ...
  - background: bg-cyan-50/80
    slides:
      - slideTitle: Selamat Datang di Sekolah Kami
        subtitle: Membangun Generasi Unggul dan Berkarakter Islami
        ...
        secondaryButton:
          ...
          href: /pendaftaran
      - slideTitle: PSB 2026 Resmi Dibuka!
        subtitle: Bergabunglah Bersama Institusi Pendidikan Terakreditasi Unggul.
        description: 'Kami bangga mengumumkan bahwa institusi kami telah resmi Terakreditasi. Ini adalah wujud komitmen nyata kami dalam menghadirkan standar pendidikan berkualitas tinggi, fasilitas terbaik, dan lingkungan belajar yang teruji untuk masa depan putra-putri Anda.'
        slideImage: /uploads/MASJID.webp
        primaryButton:
          label: Daftar Sekarang
          href: form.google.com
    autoPlay: true
